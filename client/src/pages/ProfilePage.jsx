...
function ProfilePage() {
    ...
    const onSubmitHandler = async (e) => {
        ...
        // Simulate a network delay for testing purposes (e.g., 2 seconds)
        // In a real application, you would remove this setTimeout.
        ...
        try {
            ...
            await new Promise((resolve, reject) => {
                reader.onloadend = async () => {
                    ...
                    resolve(); // Resolve the promise once updateProfile is done
                };
    ...
    return (
        // Conditionally render the loader or the profile page content
        loading ? (
            <Loader />
        ) : (
