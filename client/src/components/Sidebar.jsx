      ...
      <div className='pb-5'>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
          ...
          <input
            ...
            type="text"
            className='bg-transparent border-none outline-none text-white text-xl placeholder-[#c8c8c8] flex-1'
            placeholder='Search...'
          />
        </div>
      </div>
      ...
      <div className='flex flex-col'>
        {filteredUsers.map((user, index) => (
          <div
            ...
            key={index}
            className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}
          >
